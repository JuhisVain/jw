...
(defun test-slowest-movecosts ()
  ...
  (defmovecosts infantry (grass 40) (hill 50) (mountain 80) (nforest 50)
		(sea +inf+) (city 20) (port 20) (stream 20) (river 50) (rail 20)
		(mine 20) (pumpjack 20) (road 20))
  (defmovecosts cavalry (grass 30) (hill 40) (mountain 80) (nforest 50)
		(sea +inf+) (city 20) (port 20) (stream 20) (river 50) (rail 15)
		(mine 20) (pumpjack 20) (road 15))
  (defmovecosts wheeled (grass 25) (hill 30) (mountain 100) (nforest 70)
		(sea +inf+) (city 10) (port 10) (stream 70) (river 90) (rail 10)
		(mine 20) (pumpjack 20) (road 10))
  (defmovecosts towed (grass 60) (hill 80) (mountain 100) (nforest 70)
		(sea +inf+) (city 30) (port 30) (stream 70) (river 90) (rail 30)
		(mine 20) (pumpjack 20) (road 30))
  (defmovecosts rail (grass +inf+) (hill +inf+) (mountain +inf+) (nforest +inf+)
		(sea +inf+) (city +inf+) (port +inf+) (stream +inf+)
		(river +inf+) (rail 5) (mine +inf+) (pumpjack +inf+) (road +inf+))
  (defmovecosts moveable (grass +inf+) (hill +inf+) (mountain +inf+) (nforest +inf+)
		(sea +inf+) (city +inf+) (port +inf+) (stream +inf+) (river +inf+)
		(mine +inf+) (pumpjack +inf+) (rail +inf+) (road +inf+))
  (defmovecosts sea (grass +inf+) (hill +inf+) (mountain +inf+) (nforest +inf+)
		(sea 10) (city 10) (port 10) (stream +inf+) (river +inf+)
		(mine +inf+) (pumpjack +inf+) (rail +inf+) (road +inf+))
